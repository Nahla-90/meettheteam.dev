...
class srcApp_KernelTestDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\ColleagueController' => 'getColleagueControllerService',
            ...
            'console.command.public_alias.App\\Command\\RegisterUserCommand' => 'getRegisterUserCommandService',
            ...
            'vich_uploader.namer_uniqid.colleague_image' => 'getVichUploader_NamerUniqid_ColleagueImageService',
    ...
    protected function getBaseControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\BaseController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\ColleagueController' shared autowired service.
     *
     * @return \App\Controller\ColleagueController
     */
    protected function getColleagueControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/ControllerTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/BaseController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/ColleagueController.php';

        $this->services['App\\Controller\\ColleagueController'] = $instance = new \App\Controller\ColleagueController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\ColleagueController', $this));
    ...
    /**
     * Gets the public 'console.command.public_alias.App\Command\RegisterUserCommand' shared autowired service.
     *
     * @return \App\Command\RegisterUserCommand
     */
    protected function getRegisterUserCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/RegisterUserCommand.php';

        return $this->services['console.command.public_alias.App\\Command\\RegisterUserCommand'] = new \App\Command\RegisterUserCommand(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()));
    }
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ($this->privates['doctrine.dbal.connection_factory'] ?? ($this->privates['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([])))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '3306', 'dbname' => 'meettheteam', 'user' => 'root', 'password' => 'password', 'charset' => 'UTF8', 'driverOptions' => [], 'serverVersion' => '5.7.22', 'defaultTableOptions' => ['charset' => 'UTF8', 'collate' => 'utf8_unicode_ci']], ($this->privates['doctrine.dbal.default_connection.configuration'] ?? $this->getDoctrine_Dbal_DefaultConnection_ConfigurationService()), ($this->privates['doctrine.dbal.default_connection.event_manager'] ?? $this->getDoctrine_Dbal_DefaultConnection_EventManagerService()), []);
    }
    ...
    protected function getTest_PrivateServicesLocatorService()
    {
        return $this->services['test.private_services_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Command\\RegisterUserCommand' => ['services', 'console.command.public_alias.App\\Command\\RegisterUserCommand', 'getRegisterUserCommandService', false],
            'App\\Form\\ColleagueType' => ['privates', 'App\\Form\\ColleagueType', 'getColleagueTypeService', false],
            'App\\Form\\EmailLoginType' => ['privates', 'App\\Form\\EmailLoginType', 'getEmailLoginTypeService', false],
            'App\\Form\\OtpLoginType' => ['privates', 'App\\Form\\OtpLoginType', 'getOtpLoginTypeService', false],
            'App\\Repository\\ColleagueRepository' => ['privates', 'App\\Repository\\ColleagueRepository', 'getColleagueRepositoryService', false],
            ...
            'Knp\\Bundle\\GaufretteBundle\\FilesystemMap' => ['services', 'knp_gaufrette.filesystem_map', 'getKnpGaufrette_FilesystemMapService', false],
            ...
            'Symfony\\Component\\Security\\Core\\User\\UserProviderInterface' => ['privates', 'security.user.provider.concrete.users_in_memory', 'getSecurity_User_Provider_Concrete_UsersInMemoryService', false],
            ...
            'Vich\\UploaderBundle\\Metadata\\CacheWarmer' => ['privates', 'Vich\\UploaderBundle\\Metadata\\CacheWarmer', 'getCacheWarmer2Service', false],
            ...
            'argument_resolver.controller_locator' => ['privates', '.service_locator.AtETsnK', 'get_ServiceLocator_AtETsnKService', false],
            ...
            'cache.default_redis_provider' => ['privates', '.cache_connection.8zx.G5r', 'get_CacheConnection_8zx_G5rService', false],
            ...
            'security.user.provider.concrete.users_in_memory' => ['privates', 'security.user.provider.concrete.users_in_memory', 'getSecurity_User_Provider_Concrete_UsersInMemoryService', false],
            ...
            'vich_uploader.listener.clean.colleague_image' => ['privates', 'vich_uploader.listener.clean.colleague_image', 'getVichUploader_Listener_Clean_ColleagueImageService', false],
            'vich_uploader.listener.remove.colleague_image' => ['privates', 'vich_uploader.listener.remove.colleague_image', 'getVichUploader_Listener_Remove_ColleagueImageService', false],
            'vich_uploader.listener.upload.colleague_image' => ['privates', 'vich_uploader.listener.upload.colleague_image', 'getVichUploader_Listener_Upload_ColleagueImageService', false],
            ...
            'App\\Form\\ColleagueType' => '?',
            'App\\Form\\EmailLoginType' => '?',
            'App\\Form\\OtpLoginType' => '?',
            'App\\Repository\\ColleagueRepository' => '?',
            ...
            'vich_uploader.listener.clean.colleague_image' => '?',
            'vich_uploader.listener.remove.colleague_image' => '?',
            'vich_uploader.listener.upload.colleague_image' => '?',
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('path_colleague_image', '/uploads/images/colleagues');
    ...
    /**
     * Gets the public 'vich_uploader.namer_uniqid.colleague_image' shared service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer
     */
    protected function getVichUploader_NamerUniqid_ColleagueImageService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/vich/uploader-bundle/src/Naming/NamerInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/vich/uploader-bundle/src/Naming/Polyfill/FileExtensionTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/vich/uploader-bundle/src/Naming/UniqidNamer.php';

        return $this->services['vich_uploader.namer_uniqid.colleague_image'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }
    ...
    /**
     * Gets the private '.cache_connection.8zx.G5r' shared service.
     *
     * @return \Symfony\Component\Cache\Adapter\AbstractAdapter
     */
    protected function get_CacheConnection_8zx_G5rService()
    {
        return $this->privates['.cache_connection.8zx.G5r'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createConnection('redis://localhost:6379', ['lazy' => true]);
    }
    ...
    /**
     * Gets the private '.errored..service_locator.G9yE1tw.App\Entity\Colleague' shared service.
     *
     * @return \App\Entity\Colleague
     */
    protected function getColleagueService()
    {
        $this->throw('Cannot autowire service ".service_locator.G9yE1tw": it references class "App\\Entity\\Colleague" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.snltFxQ.App\Entity\Users' shared service.
     *
     * @return \App\Entity\Users
     */
    protected function getUsersService()
    {
        $this->throw('Cannot autowire service ".service_locator.snltFxQ": it references class "App\\Entity\\Users" but no such service exists.');
    }
    ...
    /**
     * Gets the private '.service_locator.AtETsnK' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_AtETsnKService()
    {
        return $this->privates['.service_locator.AtETsnK'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\BaseController::sendOtp' => ['privates', '.service_locator.snltFxQ', 'get_ServiceLocator_SnltFxQService', false],
            'App\\Controller\\ColleagueController::delete' => ['privates', '.service_locator.G9yE1tw', 'get_ServiceLocator_G9yE1twService', false],
            'App\\Controller\\ColleagueController::edit' => ['privates', '.service_locator.G9yE1tw', 'get_ServiceLocator_G9yE1twService', false],
            'App\\Controller\\ColleagueController::index' => ['privates', '.service_locator.a7_2yoA', 'get_ServiceLocator_A72yoAService', false],
            'App\\Controller\\ColleagueController::sendOtp' => ['privates', '.service_locator.snltFxQ', 'get_ServiceLocator_SnltFxQService', false],
            'App\\Controller\\ColleagueController::show' => ['privates', '.service_locator.G9yE1tw', 'get_ServiceLocator_G9yE1twService', false],
            'App\\Controller\\SecurityController::confirmOtp' => ['privates', '.service_locator.JTO0v3v', 'get_ServiceLocator_JTO0v3vService', false],
            'App\\Controller\\SecurityController::login' => ['privates', '.service_locator.f.MCe8A', 'get_ServiceLocator_F_MCe8AService', false],
            'App\\Controller\\SecurityController::sendOtp' => ['privates', '.service_locator.snltFxQ', 'get_ServiceLocator_SnltFxQService', false],
            'App\\Controller\\BaseController:sendOtp' => ['privates', '.service_locator.snltFxQ', 'get_ServiceLocator_SnltFxQService', false],
            'App\\Controller\\ColleagueController:delete' => ['privates', '.service_locator.G9yE1tw', 'get_ServiceLocator_G9yE1twService', false],
            'App\\Controller\\ColleagueController:edit' => ['privates', '.service_locator.G9yE1tw', 'get_ServiceLocator_G9yE1twService', false],
            'App\\Controller\\ColleagueController:index' => ['privates', '.service_locator.a7_2yoA', 'get_ServiceLocator_A72yoAService', false],
            ...
            'App\\Controller\\BaseController::sendOtp' => '?',
            'App\\Controller\\ColleagueController::delete' => '?',
            'App\\Controller\\ColleagueController::edit' => '?',
            'App\\Controller\\ColleagueController::index' => '?',
            'App\\Controller\\ColleagueController::sendOtp' => '?',
            'App\\Controller\\ColleagueController::show' => '?',
            'App\\Controller\\SecurityController::confirmOtp' => '?',
            'App\\Controller\\SecurityController::login' => '?',
            'App\\Controller\\SecurityController::sendOtp' => '?',
            'App\\Controller\\BaseController:sendOtp' => '?',
            'App\\Controller\\ColleagueController:delete' => '?',
            'App\\Controller\\ColleagueController:edit' => '?',
            'App\\Controller\\ColleagueController:index' => '?',
    ...
    /**
     * Gets the private '.service_locator.G9yE1tw' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_G9yE1twService()
    {
        return $this->privates['.service_locator.G9yE1tw'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'colleague' => ['privates', '.errored..service_locator.G9yE1tw.App\\Entity\\Colleague', NULL, 'Cannot autowire service ".service_locator.G9yE1tw": it references class "App\\Entity\\Colleague" but no such service exists.'],
        ], [
            'colleague' => 'App\\Entity\\Colleague',
        ]);
    }

    /**
     * Gets the private '.service_locator.JTO0v3v' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_JTO0v3vService()
    {
        return $this->privates['.service_locator.JTO0v3v'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /**
     * Gets the private '.service_locator.a7_2yoA' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_A72yoAService()
    {
        return $this->privates['.service_locator.a7_2yoA'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'colleagueRepository' => ['privates', 'App\\Repository\\ColleagueRepository', 'getColleagueRepositoryService', false],
        ], [
            'colleagueRepository' => 'App\\Repository\\ColleagueRepository',
        ]);
    }

    /**
     * Gets the private '.service_locator.f.MCe8A' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_F_MCe8AService()
    {
        return $this->privates['.service_locator.f.MCe8A'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'mailer' => ['privates', 'mailer.mailer', 'getMailer_MailerService', false],
            'usersRepository' => ['privates', 'App\\Repository\\UsersRepository', 'getUsersRepositoryService', false],
        ], [
            'mailer' => '?',
    ...
    /**
     * Gets the private '.service_locator.snltFxQ' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_SnltFxQService()
    {
        return $this->privates['.service_locator.snltFxQ'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'mailer' => ['privates', 'mailer.mailer', 'getMailer_MailerService', false],
            'user' => ['privates', '.errored..service_locator.snltFxQ.App\\Entity\\Users', NULL, 'Cannot autowire service ".service_locator.snltFxQ": it references class "App\\Entity\\Users" but no such service exists.'],
        ], [
            'mailer' => '?',
    ...
    /**
     * Gets the private 'App\Form\ColleagueType' shared autowired service.
     *
     * @return \App\Form\ColleagueType
     */
    protected function getColleagueTypeService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/AbstractType.php';
        include_once \dirname(__DIR__, 4).'/src/Form/ColleagueType.php';

        return $this->privates['App\\Form\\ColleagueType'] = new \App\Form\ColleagueType();
    }

    /**
     * Gets the private 'App\Form\EmailLoginType' shared autowired service.
     *
     * @return \App\Form\EmailLoginType
     */
    protected function getEmailLoginTypeService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/AbstractType.php';
        include_once \dirname(__DIR__, 4).'/src/Form/EmailLoginType.php';

        return $this->privates['App\\Form\\EmailLoginType'] = new \App\Form\EmailLoginType();
    }

    /**
     * Gets the private 'App\Form\OtpLoginType' shared autowired service.
     *
     * @return \App\Form\OtpLoginType
     */
    protected function getOtpLoginTypeService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/AbstractType.php';
        include_once \dirname(__DIR__, 4).'/src/Form/OtpLoginType.php';

        return $this->privates['App\\Form\\OtpLoginType'] = new \App\Form\OtpLoginType();
    }

    /**
     * Gets the private 'App\Repository\ColleagueRepository' shared autowired service.
     *
     * @return \App\Repository\ColleagueRepository
     */
    protected function getColleagueRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/ColleagueRepository.php';

        return $this->privates['App\\Repository\\ColleagueRepository'] = new \App\Repository\ColleagueRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    protected function getTransliteratorService()
    {
        ...
        return $this->privates['Vich\\UploaderBundle\\Util\\Transliterator'] = new \Vich\UploaderBundle\Util\Transliterator(($this->privates['slugger'] ?? ($this->privates['slugger'] = new \Symfony\Component\String\Slugger\AsciiSlugger())));
    }
    ...
    {
        return $this->privates['cache.annotations.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dMnIJ6nfP5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        $this->privates['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\RedisAdapter(($this->privates['.cache_connection.8zx.G5r'] ?? $this->get_CacheConnection_8zx_G5rService()), 'qGf+RPYb2C', 0, ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['cache.property_info.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qWcsL-7qwy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('U+yLjbFyv9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7Nbf-XNtlK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TZdxb5P+EB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MOCu8+ySir', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getConsole_Command_FormDebugService()
    {
        ...
        $this->privates['console.command.form_debug'] = $instance = new \Symfony\Component\Form\Command\DebugCommand(($this->privates['form.registry'] ?? $this->getForm_RegistryService()), [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type', 1 => 'App\\Form', 2 => 'Symfony\\Bridge\\Doctrine\\Form\\Type', 3 => 'Vich\\UploaderBundle\\Form\\Type'], [0 => 'App\\Form\\ColleagueType', 1 => 'App\\Form\\EmailLoginType', 2 => 'App\\Form\\OtpLoginType', 3 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FormType', 4 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\ChoiceType', 5 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\FileType', 6 => 'Symfony\\Bridge\\Doctrine\\Form\\Type\\EntityType', 7 => 'Vich\\UploaderBundle\\Form\\Type\\VichFileType', 8 => 'Vich\\UploaderBundle\\Form\\Type\\VichImageType'], [0 => 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TransformationFailureExtension', 1 => 'Symfony\\Component\\Form\\Extension\\HttpFoundation\\Type\\FormTypeHttpFoundationExtension', 2 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\FormTypeValidatorExtension', 3 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\RepeatedTypeValidatorExtension', 4 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\SubmitTypeValidatorExtension', 5 => 'Symfony\\Component\\Form\\Extension\\Validator\\Type\\UploadValidatorExtension', 6 => 'Symfony\\Component\\Form\\Extension\\Csrf\\Type\\FormTypeCsrfExtension', 7 => 'Symfony\\Component\\Form\\Extension\\DataCollector\\Type\\DataCollectorTypeExtension'], [0 => 'Symfony\\Component\\Form\\Extension\\Validator\\ValidatorTypeGuesser', 1 => 'Symfony\\Bridge\\Doctrine\\Form\\DoctrineOrmTypeGuesser'], ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService()));
    ...
    protected function getDebug_ArgumentResolver_NotTaggedController_InnerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller.inner'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.AtETsnK'] ?? $this->get_ServiceLocator_AtETsnKService()));
    }
    ...
    protected function getDebug_ArgumentResolver_Service_InnerService()
    {
        ...
        return $this->privates['debug.argument_resolver.service.inner'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(($this->privates['.service_locator.AtETsnK'] ?? $this->get_ServiceLocator_AtETsnKService()));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_EventManagerService()
    {
        ...
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.clean.colleague_image'] ?? $this->getVichUploader_Listener_Clean_ColleagueImageService()));
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.remove.colleague_image'] ?? $this->getVichUploader_Listener_Remove_ColleagueImageService()));
        $instance->addEventSubscriber(($this->privates['vich_uploader.listener.upload.colleague_image'] ?? $this->getVichUploader_Listener_Upload_ColleagueImageService()));
    ...
    protected function getDoctrine_Migrations_DependencyFactoryService()
    {
        ...
        return $this->privates['doctrine.migrations.dependency_factory'] = \Doctrine\Migrations\DependencyFactory::fromEntityManager(($this->privates['doctrine.migrations.configuration_loader'] ?? $this->getDoctrine_Migrations_ConfigurationLoaderService()), ($this->privates['doctrine.migrations.em_loader'] ?? $this->getDoctrine_Migrations_EmLoaderService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()));
    }
    ...
    protected function getSecurity_Firewall_Map_Config_MainService()
    {
        ...
        return $this->privates['security.firewall.map.config.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.users_in_memory', 'main', NULL, NULL, NULL, [0 => 'anonymous'], NULL);
    }
     ...
     */
    protected function getSecurity_User_Provider_Concrete_UsersInMemoryService()
    {
    ...
    protected function getSluggerService()
    {
        ...
        return $this->privates['slugger'] = new \Symfony\Component\String\Slugger\AsciiSlugger();
    }
    ...
    /**
     * Gets the private 'vich_uploader.listener.clean.colleague_image' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\CleanListener
     */
    protected function getVichUploader_Listener_Clean_ColleagueImageService()
    {
        return $this->privates['vich_uploader.listener.clean.colleague_image'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('colleague_image', ($this->privates['vich_uploader.adapter.orm'] ?? ($this->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($this->privates['vich_uploader.metadata_reader'] ?? $this->getVichUploader_MetadataReaderService()), ($this->services['vich_uploader.upload_handler'] ?? $this->getVichUploader_UploadHandlerService()));
    }

    /**
     * Gets the private 'vich_uploader.listener.remove.colleague_image' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener
     */
    protected function getVichUploader_Listener_Remove_ColleagueImageService()
    {
        return $this->privates['vich_uploader.listener.remove.colleague_image'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('colleague_image', ($this->privates['vich_uploader.adapter.orm'] ?? ($this->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($this->privates['vich_uploader.metadata_reader'] ?? $this->getVichUploader_MetadataReaderService()), ($this->services['vich_uploader.upload_handler'] ?? $this->getVichUploader_UploadHandlerService()));
    }

    /**
     * Gets the private 'vich_uploader.listener.upload.colleague_image' shared service.
     *
     * @return \Vich\UploaderBundle\EventListener\Doctrine\UploadListener
     */
    protected function getVichUploader_Listener_Upload_ColleagueImageService()
    {
        return $this->privates['vich_uploader.listener.upload.colleague_image'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('colleague_image', ($this->privates['vich_uploader.adapter.orm'] ?? ($this->privates['vich_uploader.adapter.orm'] = new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter())), ($this->privates['vich_uploader.metadata_reader'] ?? $this->getVichUploader_MetadataReaderService()), ($this->services['vich_uploader.upload_handler'] ?? $this->getVichUploader_UploadHandlerService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'path_colleague_image' => '/uploads/images/colleagues',
            ...
            'vich_uploader.mappings' => [
                'colleague_image' => [
                    'uri_prefix' => '/uploads/images/colleagues',
                    'upload_destination' => (\dirname(__DIR__, 4).'/src/../public/uploads/images/colleagues'),
                    'inject_on_load' => false,
                    'delete_on_update' => true,
                    'delete_on_remove' => true,
                    'namer' => [
                        'service' => 'vich_uploader.namer_uniqid.colleague_image',
                        'options' => [
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.App\\Command\\RegisterUserCommand',
            ],
        ];
    }
