...
return [
    ...
    [ // $dynamicRoutes
        ...
        191 => [[['_route' => 'colleague_show', '_controller' => 'App\\Controller\\ColleagueController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        204 => [[['_route' => 'colleague_edit', '_controller' => 'App\\Controller\\ColleagueController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        212 => [
